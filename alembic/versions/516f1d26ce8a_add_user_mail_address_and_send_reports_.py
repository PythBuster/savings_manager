...
def upgrade() -> None:
    ...
    op.add_column('app_settings', sa.Column('send_reports_via_email', sa.Boolean(), server_default='false', nullable=False, comment='Tells if receiving reports via report_sender is desired.'))
    op.add_column('app_settings', sa.Column('user_email_address', sa.String(), nullable=True, comment='Users report_sender address. Will used for receiving reports.'))
