...
def upgrade() -> None:
    ...
    op.add_column('app_settings', sa.Column('send_reports_via_email', sa.Boolean(), server_default='false', nullable=False, comment='Tells if receiving reports via email is desired.'))
    op.add_column('app_settings', sa.Column('user_email_address', sa.String(), nullable=True, comment='Users email address. Will used for receiving reports.'))
