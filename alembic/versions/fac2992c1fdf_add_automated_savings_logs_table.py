...
def upgrade() -> None:
    ...
    op.create_table('automated_savings_logs',
    sa.Column('action_at', sa.DateTime(timezone=True), nullable=False, comment='The utc datetime of the action.'),
    sa.Column('action', sa.Enum('ACTIVATED_AUTOMATED_SAVING', 'DEACTIVATED_AUTOMATED_SAVING', 'APPLIED_AUTOMATED_SAVING', 'CATCHED_UP_AUTOMATED_SAVING', 'CHANGED_AUTOMATED_SAVINGS_AMOUNT', name='actiontype'), nullable=False, comment='The action type within the automated savings and automated savings logs.'),
    sa.Column('details', sa.JSON(), nullable=True, comment='Metadata for the action, like app settings data.'),
